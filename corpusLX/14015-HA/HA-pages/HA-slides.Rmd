...
print("placeholder <document start>")
```
...
```
---
```{r fig-02-dist-rel,echo=F,fig.cap="relative distribution of lemmas over corpora. ICE data from study."}
...
```{r fig-05-sema-T-make,echo=F, eval=F,fig.cap="semasiological: sum T-score of near synonymes to make"}
...
```{r fig-06-sema-T-take,echo=F, eval=F,fig.cap="semasiological: sum T-score of near synonymes to take"}
...
```{r fig-07-sema-p-make,echo=F, eval=F,fig.cap="semasiological: p of near synonymes to make"}
par(las=3)
...
```{r fig-08-sema-p-take,echo=F, eval=F,fig.cap="semasiological: p of near synonymes to take"}
#getwd()
par(las=3)
