...
## eval method model: `r model.n`

### meta 
eval output data: `r dataset``r caption.ext`, wordcount: `r swc`.   
...
```{r,label=barplot-median<<model>>,echo=F,warning=F,message=F,fig.cap=paste0("mean distances over query/corpus",caption.ext)}
dfe<-eval.1$plot.md
...
```{r,label=barplot-mean<<model>>,echo=F,warning=F,message=F,fig.cap=paste0("median distances over query/corpus",caption.ext)}
