...
Our basic assumptions rely on the *taxonomy of given end new information* coined by (Prince 1981). She develops a hierarchy of references(fn:informations in a text) with specified relations to each other, where each item is attributed in terms of *familiarity*, i.e.
