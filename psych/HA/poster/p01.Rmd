...
```{r,df1-print,message=F,warning=F,echo=FALSE,eval=T}
#knitr::include_graphics("~/Documents/GitHub/school/papers/017/twitter-x.jpg",dpi = 150)
#df1
```
...
#bar_matrix <- t(as.matrix(df1_wide[, 3:length(df1_wide)]))
