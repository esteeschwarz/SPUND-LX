...
regx7
sum(m7)
k4$paradigm_he[m7]<-stri_extract_all_regex(k4$token,regx7)[m7]
k4$paradigm_lat[m7]<-"-e"
#########################
m8<-grepl(regx8,k4$token)
regx8
sum(m8)
###
k4$paradigm_he[m8]<-stri_extract_all_regex(k4$token,regx8)[m8]
k4$paradigm_lat[m8]<-"-er"
###
m9<-grepl(regx9,k4$token)
regx9
sum(m9)
###
k4$paradigm_he[m9]<-stri_extract_all_regex(k4$token,regx9)[m9]
k4$paradigm_lat[m9]<-"-en"
...
k4$kwic<-NA
length(k4$id[!is.na(k4$paradigm_lat)])
...
#mode(k5$paradigm_lat)<-"character"
