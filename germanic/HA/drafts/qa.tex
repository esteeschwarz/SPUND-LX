...
\newcommand{\doctitle}{annotations}
...
\caption{BSI: annotations}\tabularnewline
\toprule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
1 & Wie KI unsere Sprache verändert -- Eine empirische Studie \\
...
\subsection{notes on}\label{notes-on-1}

paper: Yakura et al. (2025)
...
\caption{Yakura, LLM influence: annotations}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedleft
id
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
