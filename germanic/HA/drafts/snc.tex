...
\tightlist
\item
  snc.1.2.2.3.4,cache R,docker wks,render in container wks.,new
  build,syntax,5,wks.
\end{itemize}

\paragraph{16132.fin}\label{fin}

\begin{itemize}
\tightlist
\item
  render in git runner, chrome headless html \textgreater{} pdf export
  from quarto doc.
\item
  abgabe poster: 20260329(18.29)
  \url{https://esteeschwarz.github.io/DC-LX/essais/germanic/001/16838_HA_stschwarz-posterA0.pdf}
\end{itemize}
