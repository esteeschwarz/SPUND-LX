...
\newcommand{\doctitle}{balkons u. die straszenbahn}
...
\newcommand{\docfoot}{the anarkkiv lankalevikki worksheet collection}
...
\title{balkons u. die straszenbahn}
\usepackage{etoolbox}
\makeatletter
...
\hyperref[tofollow]{shibboleth} (שִׁבֹּלֶת, cf. Sefaria
