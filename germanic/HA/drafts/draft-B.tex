...
\newcommand{\doctitle}{xtitle/AI}
\newcommand{\docsubtitle}{AI and language variation :: change}
...
\makeatother
\subtitle{AI and language variation :: change}
\author{st. schwarz}
\date{2026-04-03}
\begin{document}
\maketitle
...
\paragraph{characteristics of the optimal
prompt}\label{characteristics-of-the-optimal-prompt}
...
\paragraph{Empirical evidence of Large Language Model's influence on
human spoken
communication}\label{empirical-evidence-of-large-language-models-influence-on-human-spoken-communication}
