...
Something similar, though less drastic, can happen to people who, to name just a few prominent examples, mispronounce [derrida](#tofollow), [bourdieu](#tofollow), [accessoir](#tofollow) or, to return to the subject, [shibboleth](#tofollow) (\he{ שִׁבֹּלֶת}, cf. @sefaria_judges_2025) or, to begin the queries, say `r ipa("[balkoːɴ]")` instead of `r ipa("[balkɔɳ]")` and /tram/ instead of /straszenbahn/.
