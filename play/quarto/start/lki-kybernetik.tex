...
\newcommand{\doctitle}{kybernetik}
\newcommand{\docsubtitle}{Norbert Wiener - Regelung und Nachrichtenübertragung im Lebewesen und in der Maschine}
\newcommand{\docdate}{2026-04-18}
% DEBUG docmeta type=Para
\newcommand{\docmeta}{class: {[}16431{]} Literatur und KI :: tutor: marlene schwarz :: term:
SS26 snc: 16172.1}
...
\makeatother
\subtitle{Norbert Wiener - Regelung und Nachrichtenübertragung im
...
\href{https://github.com/esteeschwarz/SPUND-LX/commit/?meta:git-sha}{to
commit}
...
(dem wortlaut nach\ldots) betrachtet werden kann, war mathematiker am
MIT und umreiszt in der einleitung zur 1963 erschienenen Kybernetik
...
\pandocbounded{\includegraphics[keepaspectratio]{wiener-exc-001.png}} Q:
Wiener (1961)
...
aus dem griechischen »κvßερvήΤη\textasciitilde« oder »Steuermann«
bildeten''. auch gouverneur udgl. ist hier etymologisch verwurzelt.
...
\bibitem[\citeproctext]{ref-wiener_cybernetics_1961}
Wiener, Norbert. 1961. \emph{Cybernetics or {Control} and
