...
\newcommand{\doctitle}{LX / LFG}
\newcommand{\docsubtitle}{Einführung in die Grammatiktheorie und in die computationelle Modellierung am Beispiel der Lexikalisch-Funktionale Grammatik (LFG)}
\newcommand{\docdate}{2026-04-28}
% DEBUG docmeta type=Para
\newcommand{\docmeta}{class: {[}16849{]} Einführung in die Grammatiktheorie :: tutor:
meinschäfer/gaglia :: term: SS26 snc: 16184.1}
...
\makeatother
\subtitle{Einführung in die Grammatiktheorie und in die computationelle
Modellierung am Beispiel der Lexikalisch-Funktionale Grammatik (LFG)}
\author{}
\date{2026-04-28}
\begin{document}
\maketitle
...
\tightlist
\item
  samling: margin notes general \textgreater{} \hyperref[]{link}
\item
  \href{lfg-001.qmd}{task session 3}
\end{enumerate}
