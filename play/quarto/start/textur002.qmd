...
which you see as formula in the script, where the negative sum of all probabilities of units is multiplied by the log2 ("bits" of information) of these probabilities (cf. @shannon_mathematical_1949 : 23)

$H(X) := -\sum_{x \in \mathcal{X}} p(x) \log2 p(x)$
