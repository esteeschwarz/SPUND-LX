...
\begin{verbatim}
annotations: Wiener_Einführung.pdf
\end{verbatim}

\begin{longtable*}[t]{>{\raggedright\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{7cm}>{\raggedright\arraybackslash}p{4cm}}
\toprule
page & note & comment\\
\midrule
...
12 & Wir haben beschlossen, das ganze Gebiet der Regelung und Nachrichtentheorie, ob in der Maschine oder im Tier, mit dem Namen »Kybernetik« zu benennen, den wir aus dem griechischen »κvßερvήΤη\textasciitilde{}« oder »Steuermann« bildeten & \\
\addlinespace
