# -*- coding: utf-8 -*-
"""Kopie von stable_diffusion.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19rURI46z6ouARvZKa4HxqMLHfVhPluIm
...
!pip install --upgrade huggingface-hub>=0.33.5 transformers==4.46.1 tokenizers==0.20.1 diffusers==0.31.0
...
prompt = "a cat in a porridge bowl"
image = pipe(prompt).images[0]  # image here is in [PIL format](https://pillow.readthedocs.io/en/stable/)

# Now to display an image you can either save it such as:
#image.save(f"astronaut_rides_horse.png")
image.save(f"cat01.png")
...
prompt = ["a cat in a fishbowl"] * num_images
