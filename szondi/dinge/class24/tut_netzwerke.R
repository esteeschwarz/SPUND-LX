...
net <- read_graph("idia-vis.graphml", format="graphml")
...
# edges<-df$edgeLabel
indeg <- degree(net, mode = "all",  # mode = "out" für outdegree centrality, "all" für gesamte Dichte
...
#      edge.weight=1, edge.width=(E(net)$weight/6),
#      layout = layout_1)
# # 
