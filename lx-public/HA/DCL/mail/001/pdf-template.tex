...
% LEFT LOGO
$if(logo-left)$
\includegraphics[width=10mm,height=10mm,keepaspectratio]{$logo-left$}
$endif$
&
% CENTER TITLE BLOCK
...
% RIGHT MOTTO
$if(logo-right)$
\includegraphics[height=10mm,keepaspectratio]{$logo-right$}
$endif$
...
{\small
$if(author)$
\textbf{Author:} $for(author)$$author$$sep$, $endfor$\\
$endif$
