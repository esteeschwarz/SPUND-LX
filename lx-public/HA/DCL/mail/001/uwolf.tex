...
% \newfontfamily\hebrewfontdep{Noto Serif Hebrew}[Script=Hebrew]
...
% \setmainfont{Noto Serif}[
%   Renderer=HarfBuzz,
%   RawFeature={fallback=fb}
% ]
% \directlua{
% local hebrew_range = {0x0590,0x05FF}

% callback.register("pre_linebreak_filter",
%   function(head)
%     tex.set("textdir","TLT")
%     for n in node.traverse_id(node.id("glyph"), head) do
%       if n.char >= hebrew_range[1] and n.char <= hebrew_range[2] then
%         tex.set("textdir","TRT")
%         break
%       end
%     end
...
&
% CENTER TITLE BLOCK
{\Large\bfseries 12293.wolf gossip satz für satz}
&
% RIGHT MOTTO
...
{\small
\textbf{Author:} stschwarz\\

\textbf{Date:} 2026-03-21

class: {[}16412{]} dynamiken postdeutscher gegenwartslyrik :: tutor:
chiara liso :: term: SS22 :: \textless\textless{}
\href{https://esteeschwarz.github.io/DC-LX/essais/germanic/001/gemini.html}{back
to paper \textless\textless{}}
}
...
\begin{center}
{\small
{\headerfont\bfseries the anarkkiv lankalevikki worksheet collection
\textgreater\textgreater{} \url{https://ada-sub.dh-index.org/blog}}
...
שִׁבֹּלֶת: \href{https://www.pealim.com/dict/3270-shibolet/}{die übersetzung}
...
‚nicht ausreichenden' Möglichkeiten. Eine Übersetzung muss untreu sein,
um das bloßzustellen, was das Beste „verbirgt``.''
\end{quote}
