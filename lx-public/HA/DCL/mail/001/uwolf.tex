...
\newcommand{\foot}{the anarkkiv lankalevikki worksheet collection >> https://ada-sub.dh-index.org/blog}
\newcommand{\meta}{class: [16412] dynamiken postdeutscher gegenwartslyrik :: tutor: chiara liso :: term: SS22 :: << back to paper <<}
\newcommand{\logoleft}{../fadenlogo-fwb.png}
\newcommand{\logoright}{../dcl-head-niemand.png}
\makeatletter
